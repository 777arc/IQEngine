        ...
        <div id='ConnectionStringContainer' className="form-group">
            <form onSubmit={ConnStrHandleClick}>
                <div className="form-group">
                    ...
                    <input name='accountNameRef' type='text' className="form-control" id='AccountNameInput'></input>
                    <label htmlFor="ContainerNameInput">Container Name: </label>
                    <input name='containerNameRef' type='text' className="form-control" id='ContainerNameInput'></input>
                    <label htmlFor="SASTokenInput">SAS Token: </label>
                    <input name='sasTokenRef' type='text' className="form-control" id='SASTokenInput'></input>
                </div>
                <div className="form-group">
