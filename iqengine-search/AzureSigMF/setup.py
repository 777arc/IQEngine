...
shortdesc = 'Azure Interface to Signal Metadata Format Specification'
longdesc = '''
...
samples, and features of the signal itself. This interface makes SigMF files 
that are stored in Azure blobs more accessible. 
'''

with open(os.path.join('azuresigmf', '__init__.py')) as handle:
